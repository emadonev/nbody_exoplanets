...
\begin{document}
   ...
   \titlerunning{Stability of exoplanets in hierarchical triple systems}
    ...
    As this work explores both dynamical and temperature stability, orbital and photometric data
    is required of all the stellar and planetary components. Tables \ref{tab:stellar}, \ref{tab:orbits} and \ref{tab:planets} contain
    all the data used in this work. While system LTT 1445 is described in great detail, system GJ 667 lacks precise information on the masses
    of stellar components A and B as well as their orbit. As such, their orbit can be approximated as a single body according to \citet{Desgrange2023}, effectively acting as a binary system.
    The outer orbit in GJ 667 is not precisely defined either, as only the separation between binary pair AB and star C is known. For this system a study of the parameter space
    will be done, testing a range of values for eccentricity, mutual 
    
    ...
    - explain data design

    - explain the chosen ranges of eccentricity and inclination

    - determine values of Omega, omega and T0 for the outer system as well as for the planets

    - explain that we cannot know the mutual inclination of the planets, but that we assume coplanarity
...
\begin{table*}[t]
    ...
    \begin{table*}[t]
        ...
        \begin{tabular}{lccccc}
                ...
                $i_{sky} \; (\deg)$  & $89.64 \pm 0.13$ & ${88.5^{+1.3}_{-1.4}}$ & $[0.0, 30.0, 60.0, 90.0]^{(S)}$ \\
                $i_{mut} \; (\deg)$  & - & $2.88 \pm 0.63$ & - \\
                $\Omega \; (\deg) $  & $137.63 \pm 0.19$ & $135.15 \pm 0.28$ & - \\
                $\omega \; (\deg) $  & $209 \pm 13$ & ${256^{+28}_{-21}}$ & - \\
                $T_0 \; (yr) $  & $2019.2 \pm 1.7$ & - & - \\
    ...
    \begin{table*}[t]
        ...
        \begin{tabular}{lcccccc}
                ...
                b & c & \\
                \midrule
                $M (M_\oplus)$ & $2.32 \pm 0.25$ & $1.00 \pm 0.19$ & $2.72 \pm 0.75$ & $5.6 \pm 0.3$ & $4.1 \pm 0.6$ &\\
